...
git remote add origin https://github.com/iliakirillov1111-droid/7k-casino.git
if %errorlevel% neq 0 (
    echo Remote already exists, updating URL...
    git remote set-url origin https://github.com/iliakirillov1111-droid/7k-casino.git
)
echo Adding files...
git add .
echo Committing...
